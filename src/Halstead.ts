...
export class Halstead {
    ...
    public calculate(): LsifHalstead {
        ...
        let operatorsDistinct = Array.from(new Set(this.operators));
        ...
        halstead.volume = halstead.programLength + Math.log2(halstead.programVocabulary);
        ...
        if (halstead.numOperatorsDistinct == 0) {
            return halstead;
        }
        halstead.calculatedEstimatedProgramLength =
            halstead.numOperandsDistinct * Math.log2(halstead.numOperandsDistinct) +
